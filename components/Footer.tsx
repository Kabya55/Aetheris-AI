        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <a href="https://github.com/Kabya55" target="_blank" rel="noreferrer" className="text-slate-500 hover:text-indigo-400 transition">
              ...
              <a href="https://www.linkedin.com/in/kabya-kishor-halder" target="_blank" rel="noreferrer" className="text-slate-500 hover:text-indigo-400 transition">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-400">
              ...
              <li className="flex items-center gap-2">
                ...
                <span>+8801750084574</span>
              </li>
              <li className="flex items-center gap-2">
                <Mail className="size-4 text-indigo-400 shrink-0" />
                <a href="mailto:kabyakishor017@gmail.com" className="hover:text-white transition">kabyakishor017@gmail.com</a>
              </li>
            </ul>
          </div>
